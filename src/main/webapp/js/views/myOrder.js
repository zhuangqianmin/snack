			...
			function initBind($http, $scope) {
				...
				$('#table_id_example').on('click', '.update', function () {
					...
					swal({
						...
						$http({
	   			            method: 'POST',
	   			            url:'/snack'+'/user/userOrderConfirm',
	   			            headers: {
				...
				$('#table_id_example').on('click', '.payMoney', function () {
					...
					$.ajax({
	   	 				url:'/snack'+'/user/userOrderPayMoney',
	   	 				data:{
	   	 			    	"oId":oId
	   	 			    },
	   	 				type:'post',
				...
				$('#comfirPay').on('click', function () {
					...
					if($("#uPasword").val()!=''){
						$.ajax({
		   	 				url:'/snack'+'/user/userOrderPayMoneyConfirm',
		   	 				data:{
